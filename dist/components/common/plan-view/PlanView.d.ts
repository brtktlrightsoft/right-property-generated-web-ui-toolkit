...
export default function PlanView({ planId, objects, items, background, color, canvasSubject, useHalfWidth, onNavigate, formatCurrency, t, showPrice, measurementSystem, }: PlanViewProps): import("react/jsx-runtime").JSX.Element;
